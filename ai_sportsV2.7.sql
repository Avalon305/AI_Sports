/*
 ...
 Source Schema         : testbdl0504

 Target Server Type    : MySQL
 Target Server Version : 50634
 File Encoding         : 65001

 Date: 04/05/2019 17:56:18
*/
...
CREATE TABLE `bdl_activity`  (
  ...
  `fk_member_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '会员外键id',
  `member_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '会员卡号ID',
  `activity_type` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '训练活动编码：力量循环或者力量耐力循环',
  `target_turn_number` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '目标轮次数量，目标在这一圈训练几轮',
  `current_turn_number` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '当前轮次计数',
  `is_complete` tinyint(3) UNSIGNED NULL DEFAULT 0 COMMENT '是否完成 默认0:未完成。1:完成)',
  ...
  INDEX `member_id`(`fk_training_course_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_activity训练活动表' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_auth`  (
  ...
  `authid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手环或卡的openID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_auth登录用户授权表' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_datacode`  (
  `id` int(10) NOT NULL,
  `code_xh` int(10) NULL DEFAULT NULL COMMENT '排序号，下拉列表按这个排序',
  ...
  `code_d_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '展示值',
  `code_ext_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备对应的肌肉',
  `code_ext_value2` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用作存储设备的活动类型，与编码表中的循环类型相对应：0力量循环，1力量耐力，需要用作分组查询依据',
  `code_ext_value3` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用作存储有氧力量类型：0：力量训练设备；1：有氧训练设备',
  `code_ext_value4` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备图片存储路径',
  `code_state` tinyint(4) NULL DEFAULT 1 COMMENT '是否启用 0 不启用 1启用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_datacode编码表' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_member`  (
  `id` int(10) UNSIGNED NOT NULL COMMENT '主键自增id',
  `member_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '会员id',
  `member_firstName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '会员名',
  `member_familyName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '会员姓',
  `birth_date` date NULL DEFAULT NULL COMMENT '出生日期',
  `sex` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '住址',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '住址',
  `email_address` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱地址',
  `work_phone` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '工作电话',
  `personal_phone` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '私人电话',
  `mobile_phone` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机号码',
  `weight` double(10, 2) UNSIGNED NULL DEFAULT NULL COMMENT '体重（KG）',
  `height` double(10, 2) UNSIGNED NULL DEFAULT NULL COMMENT '身高 (cm)',
  `age` int(6) UNSIGNED NULL DEFAULT NULL COMMENT '年龄',
  `max_heart_rate` int(6) UNSIGNED NULL DEFAULT NULL COMMENT '最大心率=220-age',
  `suitable_heart_rate` int(6) UNSIGNED NULL DEFAULT NULL COMMENT '最宜心率',
  `role_id` tinyint(3) UNSIGNED NULL DEFAULT 1 COMMENT '角色id，1：会员；0：教练',
  `fk_coach_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '外键关联教练id',
  `label_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标签名数组：标签名：增肌、减脂、塑形、康复，用符号分隔',
  `is_open_fat_reduction` tinyint(3) UNSIGNED NULL DEFAULT 0 COMMENT '是否开启减脂模式 默认0，0:未开启，1:开启',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '前端备注',
  `last_login_date` datetime(0) NULL DEFAULT NULL COMMENT '上次登录日期',
  `gmt_create` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `gmt_modified` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `member_id`(`member_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_member会员表' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_personal_setting`  (
  `id` int(10) UNSIGNED NOT NULL COMMENT '主键自增id',
  `fk_member_id` int(10) NULL DEFAULT NULL,
  `member_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '会员卡号ID',
  `fk_training_activity_id` int(10) NULL DEFAULT NULL COMMENT '训练活动名',
  `activity_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '训练活动类型编码',
  ...
  `lever_length` int(10) NULL DEFAULT NULL COMMENT '杠杆长度',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `member_id`(`member_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_personal_setting个人设置' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_skeleton_length`  (
  `id` int(11) NOT NULL,
  `fk_member_id` int(11) NULL DEFAULT NULL COMMENT '关联bdl_member的主键',
  `body_length` double NULL DEFAULT NULL COMMENT '躯干长度(脖子到屁股~)',
  `shouder_width` double NULL DEFAULT NULL COMMENT '肩宽(单侧肩宽)',
...
CREATE TABLE `bdl_system_setting`  (
  ...
  `organization_phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '机构电话',
  `organization_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '机构地址',
  `ip_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'ip地址',
  `system_version` tinyint(255) NULL DEFAULT NULL COMMENT '系统版本 0：标准版 1：豪华版',
  `gmt_create` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `gmt_modified` datetime(0) NULL DEFAULT NULL,
  `user_status` int(3) NULL DEFAULT NULL COMMENT '使用状态',
  `auth_offlinetime` date NULL DEFAULT NULL COMMENT '离线时间',
  `set_unique_id` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '客户机唯一id，机器码',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_system_setting系统设置' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_training_activity_record`  (
  `id` int(10) UNSIGNED NOT NULL COMMENT '主键自增id',
  `fk_training_course_id` int(10) UNSIGNED NOT NULL COMMENT '外键训练课程id',
  `fk_activity_id` int(10) NULL DEFAULT NULL COMMENT '外键，训练活动ID',
  `activity_type` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT ' 训练活动编码：力量循环或者力量耐力循环',
  `course_count` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '课程轮次计数：等于插入时训练课程表的当前课程计数，标志这条训练活动记录属于第几次的课程',
  `is_complete` tinyint(3) UNSIGNED NULL DEFAULT 0 COMMENT '是否完成 默认0:未完成。1:完成)',
  `gmt_create` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `gmt_modified` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_training_activity_record训练活动记录表' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_training_course`  (
  `id` int(10) UNSIGNED NOT NULL COMMENT '主键自增id',
  `member_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `fk_training_plan_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '外键训练计划id',
  `rest_days` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '休息天数（间隔）',
  `target_course_count` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '目标课程轮次计数=前端课程天',
  `current_course_count` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '当前课程轮次计数',
  `start_date` date NULL DEFAULT NULL COMMENT '起始日期',
  `end_date` date NULL DEFAULT NULL COMMENT '预计结束日期=起始日期+休息天数*课程天数',
  `current_end_date` date NULL DEFAULT NULL COMMENT '当前进度预计结束日期.更新完成状态时，根据计数和间隔更新此日期',
  `is_complete` tinyint(3) UNSIGNED NULL DEFAULT 0 COMMENT '是否完成 默认0:未完成。1:完成)',
  `gmt_create` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `gmt_modified` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_training_plan_id`(`fk_training_plan_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_training_course训练课程表' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_training_device_record`  (
  `id` int(10) UNSIGNED NOT NULL COMMENT '主键自增id',
  `member_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '会员id',
  `fk_training_activity_record_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '外键训练活动记录id',
  `activity_type` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '训练活动类型编码',
  `device_order_number` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '设备在循环中的序号',
  `device_code` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备名',
  `training_mode` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '训练模式',
  `consequent_force` double(10, 2) NULL DEFAULT NULL,
  `reverse_force` double(10, 2) NULL DEFAULT NULL,
  `power` double(10, 2) UNSIGNED NULL DEFAULT NULL COMMENT '功率',
  `count` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '训练个数',
  `speed` double(10, 2) UNSIGNED NULL DEFAULT NULL COMMENT '速度 1位小数 千米每时',
  `distance` double(10, 2) UNSIGNED NULL DEFAULT NULL COMMENT '距离 千米，两位小数',
  `energy` double(10, 2) NULL DEFAULT NULL COMMENT '训练总耗能 单位卡路里',
  `training_time` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '训练时间 单位秒',
  `avg_heart_rate` int(6) UNSIGNED NULL DEFAULT NULL COMMENT '平均心率',
  `max_heart_rate` int(6) UNSIGNED NULL DEFAULT NULL COMMENT '最大心率',
  `min_heart_rate` int(6) UNSIGNED NULL DEFAULT NULL COMMENT '最小心率',
  `gmt_create` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `gmt_modified` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_training_device_record训练设备记录表' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_training_plan`  (
  `id` int(10) UNSIGNED NOT NULL COMMENT '主键自增id',
  `member_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `fk_member_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '会员id',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '训练标题',
  `start_date` date NULL DEFAULT NULL COMMENT '起始日期',
  `training_target` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '训练目标',
  `is_deleted` tinyint(4) UNSIGNED NULL DEFAULT 0 COMMENT '是否删除 1:删除;0:未删除',
  `gmt_create` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `gmt_modified` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `member_id`(`member_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'bdl_training_plan训练计划表' ROW_FORMAT = Compact;
...
CREATE TABLE `bdl_uploadmanagement`  (
  ...
  `UM_Exec` int(6) UNSIGNED NULL DEFAULT NULL COMMENT '进行的操作类型 add：0  update：1',
  `UM_DataId` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '数据的id',
  `UM_DataTable` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '持有数据所在的表名',
...
CREATE TABLE `s_key`  (
  `key_id` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `max_value` bigint(20) NULL DEFAULT NULL,
  `steps` bigint(20) NULL DEFAULT NULL
